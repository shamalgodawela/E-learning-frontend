...
export default function CreateBeutyshop() {
  ...
  <h1 className="text-3xl font-bold text-black bg-purple-300 px-6 py-2 rounded-lg shadow-md">
    Create Post
  </h1>
</div>
          ...
          <div className="flex justify-center items-center">
            <div className="bg-black bg-opacity-60 p-6 rounded-2xl mt-5">
              <form
                className="flex flex-col gap-4 w-[600px] rounded-lg bg-gray-50 bg-opacity-30 border mb-10"
              ...
              >
                <div className="flex flex-col gap-4">
                  <div className="flex gap-4 items-center justify-between border-none p-3">
                    <label
                      htmlFor="uploadInput"
                      className="bg-white bg-opacity-90 w-48 h-20 hover:bg-[#d9d9da] border rounded-xl cursor-pointer"
                    >
                      <div className="mt-5">
                        <span className="text-2xl ml-16 text-gray-700 font-medium text-opacity-50">
                          Photo
                        </span>
                      </div>
                      <input
                    ...
                    <button
                      type="button"
                      className="w-28 h-8 font-medium text-sm hover:opacity-80 rounded-lg bg-gradient-to-r from-slate-500 to-blue-white border text-white"
                      size="sm"
